...
public class BlueStrafeToRamp extends LogicThread<AutonomousRobot> {
    ...
    public void loadCommands (){
        commands.add(new Translate(5500, Translate.Direction.BACKWARD_RIGHT,0)); //move away from beacon towards corner of field in front of ramp
        commands.add(new Pause(500));
        commands.add(new Rotate(-45)); //Rotate to face ramp
        commands.add(new Pause(500));
        commands.add(new Translate(3000, Translate.Direction.BACKWARD,0)); //Get onto Ramp
